...
\begin{tikzpicture}[shorten >=1pt,auto,node distance=3cm,thick,minimum height=1.0cm]
	...
	\node[]	(stat) [left of=net] {Überwachungsstation};
...
\frame{\frametitle{Openscad -- 3D-Entwurfssoftware}
	\includegraphics[width=10cm]{Openscad.png}	
}
\frame{\frametitle{Cura -- 3D-Drucksoftware}
	\includegraphics[width=10cm]{Cura.png}	
}
\frame{\frametitle{Octoprint -- 3D-Druckserver}
	\includegraphics[width=10cm]{Octoprint.png}	
}
\frame{\frametitle{Codeblocks -- Programmierumgebung}
	\includegraphics[width=10cm]{Codeblocks.png}	
}
\frame{\frametitle{Sourcetree -- Versionsverwaltung}
	\includegraphics[width=10cm]{Sourcetree.png}	
}
...
\frame{\frametitle{Überwachungsstation -- Backstage}
...
\section{Station}
\frame{\frametitle{Überwachungsstation}
	\includegraphics[width=10cm]{Station_v.jpg}	
}

\section{Projektdaten}
\frame{\frametitle{Überwachungsstation -- Daten}
	\textbf{Temperaturen}
	\begin{itemize}
		\item Raum: 26 °C
		\item Netzteil: 29 °C
		\item Rechner (außen): 32 °C
		\item Rechner (auf Kopf): 39 °C
		\item Rechner (Robosteuerung): 34 °C
		\item Dell-Laptop: 42 °C
	\end{itemize}
}
